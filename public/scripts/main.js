...
//-----------------------RESOLVED----------------------------
// I made the data an array of arrays
// -----That way the value of the selected list can easily be made into a number to refer to an array in the data set.
// -----Just have to make the string a number with the + sign.
